...
var NexChat = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        _this.api
                            ...
                            .catch(function (error) { return genericCatch(error, reject); });
                    })];
            });
        });
    };
    NexChat.prototype.updateActiveChannel = function (channelData) {
        ...
        var newChannel = new Channel(this, channelData);
    ...
    NexChat.prototype.upsertUserAsync = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.api
                            .put("/users/".concat(user.externalUserId), _.omit(user, 'externalUserId'))
                            .then(function (_a) {
                            var data = _a.data;
                            resolve(data.user);
                        })
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.api
                            ...
                            var dataWithFileUri = _.map(signedUrlList, function (signedUrl, index) {
